FROM --platform=$BUILDPLATFORM golang:1.26.3-trixie@sha256:0f6b034c99663ea8957e7dae99124e37374cbe7fcb5b5646f19b185f8f976279 AS gobuild
...
RUN GOOS=$TARGETOS GOARCH=$TARGETARCH xcaddy build \
    ...
    --with github.com/hslatman/caddy-crowdsec-bouncer/http@v0.13.0 \
    --with github.com/hslatman/caddy-crowdsec-bouncer/appsec@v0.13.0 \
    --with github.com/hslatman/caddy-crowdsec-bouncer/layer4@v0.13.0 \
